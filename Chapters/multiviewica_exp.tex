...
The \blue{subject specific} dimension reduction in MultiView ICA, PermICA,
\blue{ConcatICA and CanICA} is performed with SRM in
fMRI experiments and subject-specific PCA in MEG experiments.

\blue{The shape of the input data ($v$, $t$, $m$) depend on the dataset used and the experiment
