...
The number of massive neuroimaging datasets, containing data from hundreds of
participants has increased over the
years~\cite{taylor2017cambridge,van2013wu,sudlow2015uk}.
...
assumption can be justified by the findings of
\cite{hasson2004intersubject} showing that brains exposed to the same natural stimuli exhibit synchronous activity.
