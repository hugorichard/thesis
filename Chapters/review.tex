...
components used in the model are too far from the true components in the data. In this section, we explain
why this happens and derive stability conditions. This follows the work done in~\cite{cardoso1998blind}.

When the density of the components correspond to the one used in the model. We
...
In~\cite{guo2008unified}, the components are assumed to be a mixture of Gaussian
