...
Multiset CCA \blue{(using the SUMCORR cost function under some constraint as described in section~\ref{sec:mcca})} consists in the following generalized eigenvalue problem:
\begin{equation}
\label{eq:eigv}
