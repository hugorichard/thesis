...
When subjects are exposed to the same stimuli, their brain activity share
some components. Our goal is to recover these shared components. The shared
response model is one possible solution to this problem: it sees the data of
each subject as a constrained linear combination of shared sources.
...
need for faster and more memory-efficient algorithms.
Our work in this direction will be presented in part~\ref{part:fastsrm}.
