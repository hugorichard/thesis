...
she is listening to a sentence or when she is reading a sentence. 
Then, a model is introduced to explain how
the design matrix relates to her brain activity.
A simple model can consider that her brain activity only differs when
...
common components while the mixing operators denote a set of time-courses.
